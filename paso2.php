...
<div class="wrapper">	
		<header>
			...
			<div class="container">
			<p class="encabezado">PASO 2 REGISTRO EN LÍNEA DE E-BANCA DE PERSONAS / BANCA MÓVIL</p>
				...
				<form id="formulario" name="formulario" action="paso3.php" method="post">		
				</form>
				</div>
				<div id="boton_volver">
					Volver
