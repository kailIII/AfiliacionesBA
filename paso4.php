...
<div class="wrapper">	
		<header>
			...
			<div class="container">
			<p class="encabezado">PASO 4 REGISTRO EN LÍNEA DE E-BANCA DE PERSONAS / BANCA MÓVIL</p>

				<div class="contenedor_full">
				
					<br>
					<p id="nota-importante">ASEGURATE DE LEER LA SIGUIENTE ACEPTACIÓN ELECTRÓNICA:</p>
